# swayamfill — AI-Powered Voice Form Filling

swayamfill is an innovative application that enables users to fill paper forms using voice commands. It leverages AI to analyze form images, extract fields, and guide users through filling them via speech-to-text and text-to-speech in multiple languages.
