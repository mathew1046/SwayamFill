---
title: swayamfill Backend
sdk: docker
app_port: 7860
---

# swayamfill Backend (FastAPI)
...
```bash
# If you're running this from the repo root (swayamfill/):
...
- `swayamfill_DB_PATH` (default: `data/swayamfill.db`)
...
```bash
docker build -t swayamfill-backend .
docker run --rm -p 7860:7860 swayamfill-backend
```
